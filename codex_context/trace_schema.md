...
ttc_s = lead_distance_m / max(ego_speed_mps - lead_speed_mps, epsilon)

The Codex instruction:

Use CSV and JSONL trace export. Every verification failure must link to trace rows and timestamps.